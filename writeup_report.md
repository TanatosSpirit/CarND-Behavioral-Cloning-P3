...
The overall strategy for deriving a model architecture was to checking existing architectures.

My first step was to use a convolution neural network model similar to the model described in [Nvidia paper](https://arxiv.org/pdf/1604.07316.pdf). I thought this model might be appropriate because the model was successfully used by the Nvidia team.
...
fell off the track... to improve the driving behavior in these cases, 
I ....
